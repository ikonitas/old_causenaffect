...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OrderLine.product_name'
        db.delete_column('orders_orderline', 'product_name')

        # Adding field 'OrderLine.songs_name'
        db.add_column('orders_orderline', 'songs_name', self.gf('django.db.models.fields.CharField')(default=1, max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'OrderLine.product_name'
        db.add_column('orders_orderline', 'product_name', self.gf('django.db.models.fields.CharField')(default=1, max_length=255), keep_default=False)

        # Deleting field 'OrderLine.songs_name'
        db.delete_column('orders_orderline', 'songs_name')
