...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gallery.album_cover'
        db.add_column('photologue_gallery', 'album_cover', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='cover', unique=True, null=True, to=orm['photologue.Photo']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gallery.album_cover'
        db.delete_column('photologue_gallery', 'album_cover_id')
