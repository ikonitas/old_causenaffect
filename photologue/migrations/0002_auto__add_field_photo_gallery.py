...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.gallery'
        db.add_column('photologue_photo', 'gallery', self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['photologue.Gallery']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.gallery'
        db.delete_column('photologue_photo', 'gallery_id')
