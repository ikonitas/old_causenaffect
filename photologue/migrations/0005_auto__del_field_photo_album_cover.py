...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('photologue_photo', 'album_cover')


    def backwards(self, orm):
        
        # Adding field 'Photo.album_cover'
        db.add_column('photologue_photo', 'album_cover', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
