...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.gallery'
        db.alter_column('photologue_photo', 'gallery_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['photologue.Gallery'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Photo.gallery'
        db.alter_column('photologue_photo', 'gallery_id', self.gf('django.db.models.fields.related.ForeignKey')(default=6, to=orm['photologue.Gallery']))
