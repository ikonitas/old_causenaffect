...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 2, 24, 0, 5, 53, 241474), auto_now_add=True, blank=True)),
            ('event_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 2, 24, 0, 5, 53, 241520))),
    ...
    models = {
        ...
        'events.event': {
            ...
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 24, 0, 5, 53, 241520)'}),
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 24, 0, 5, 53, 241474)', 'auto_now_add': 'True', 'blank': 'True'}),
