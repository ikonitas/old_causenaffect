...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('events_event', ['slug'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Event', fields ['slug']
        db.delete_unique('events_event', ['slug'])
    ...
    models = {
        ...
        'events.event': {
            ...
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 22, 19, 2, 256054)'}),
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 6, 11, 22, 19, 2, 256029)', 'auto_now_add': 'True', 'blank': 'True'}),
