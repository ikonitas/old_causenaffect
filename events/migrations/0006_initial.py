...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('pub_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 2, 9, 21, 25, 2, 631230), auto_now_add=True, blank=True)),
            ('event_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2012, 2, 9, 21, 25, 2, 631254))),
    ...
    models = {
        'events.event': {
            ...
            'event_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 9, 21, 25, 2, 631254)'}),
            ...
            'pub_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 2, 9, 21, 25, 2, 631230)', 'auto_now_add': 'True', 'blank': 'True'}),
