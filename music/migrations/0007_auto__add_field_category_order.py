...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('music_category', 'order', self.gf('django.db.models.fields.IntegerField')(unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Category.order'
        db.delete_column('music_category', 'order')
