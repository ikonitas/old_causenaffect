...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Basket', fields ['song']
        db.delete_unique('basket_basket', ['song_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Basket', fields ['song']
        db.create_unique('basket_basket', ['song_id'])
    ...
    models = {
        'basket.basket': {
            ...
            'song': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'song'", 'to': "orm['music.Music']"})
        },
        'music.music': {
