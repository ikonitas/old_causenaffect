...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('basket_basket', (
            ...
            ('basket_id', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('date_added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('song', self.gf('django.db.models.fields.related.ForeignKey')(related_name='song', unique=True, to=orm['music.Music'])),
        ))
    ...
    models = {
        'basket.basket': {
            ...
            'basket_id': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
